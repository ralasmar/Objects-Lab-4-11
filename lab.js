...
hello = greeting({firstName: 'sally', lastName: 'rogers', title: 'mrs'})
console.log(hello)
//////////////////////////// PROBLEM 8 ////////////////////////////
...
sum = totalPopulation({utah: 50, california: 78, texas: 46, arizona: 304})
console.log(sum)
...
let rolasCat = new Cat('kiki', '11', 'grey');
console.log(rolasCat)
...
const wizard1 = new Wizard('rola','26', 'invisibility')
wizard1.castSpell()
//////////////////////////// PROBLEM 14 ////////////////////////////
/*
...
//Code Here
let newPhone1 = new Phone('Apple', '13', '120gb', 'white', `3000`)
let newPhone2 = new Phone('Android', 'Galaxy', '120gb', 'black', `2000`)
let newPhone3 = new Phone('Apple', '12', '80gb', 'black', `1000`)
...
//Code Here
myFirstVehicle = new Vehicle(5, 'blue', '60,000')
...
//Code Here 
myFirstMotorcycle = new Motorcycle(2, `pink`, 20000, `mazda`)
/*
...
//Code Here
myFirstBoat = new Boat(50, `pink`, `10000`, `kiki`, `bigboat`, false)
